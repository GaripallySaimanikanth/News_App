...
public class reportactivity extends AppCompatActivity
        implements LoaderManager.LoaderCallbacks<List<com.example.newsappproject_6.report>>,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new feedadapter(this, new ArrayList<com.example.newsappproject_6.report>());
        ...
        newsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                com.example.newsappproject_6.report currentNews = mAdapter.getItem(position);
    ...
    @Override
    public Loader<List<com.example.newsappproject_6.report>> onCreateLoader(int id, Bundle args) {
        setUpSharedPreferences();
    ...
    @Override
    public void onLoadFinished(@NonNull  Loader<List<com.example.newsappproject_6.report>> loader, List<com.example.newsappproject_6.report> news) {
    ...
    @Override
    public void onLoaderReset(@NonNull Loader<List<com.example.newsappproject_6.report>> loader) {

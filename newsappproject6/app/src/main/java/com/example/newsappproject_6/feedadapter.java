...
public class feedadapter extends ArrayAdapter<com.example.newsappproject_6.report> {
    private final Context mContext;
    private static final String DATE_SEPARATOR = "T";
    private static final String TIME_SEPARATOR = "Z";
    public feedadapter(Activity context, ArrayList<com.example.newsappproject_6.report> news) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.newsappproject_6.report currentNews = getItem(position);
        ...
        textViewAuthorName.setText(currentNews.getAuthorName());
